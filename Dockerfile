...
ENV POSTGRESQL_HOST=13.51.157.23
...
ENV DOCUMENT_SERVICE_BINDING_KEY=DOCUMENT_SERVICE
ENV DOCUMENT_SERVICE_RPC=DOCUMENT_SERVICE_RPC
ENV S3_BUCKET=orphansafe-s3-bucket
ENV S3_REIGON=ap-south-1
ENV S3_ACCESS_KEY_ID=AKIA5DZQMVYH3BQYG2HY
ENV S3_SECRET_ACCESS_KEY=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
